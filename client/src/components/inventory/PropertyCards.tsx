    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      {properties.map((prop) => {
        ...
        return (
          <div
            key={prop.id}
            className={`group relative flex flex-col overflow-hidden rounded-2xl border bg-[#12161F]/90 shadow-xl backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/40 hover:shadow-2xl ${
              isSelected ? 'border-amber-500 ring-1 ring-amber-500' : 'border-zinc-800/80'
            }`}
          >
            {/* Top Media Banner */}
            <div className="relative h-48 w-full overflow-hidden bg-zinc-900">
              ...
              <div className="absolute top-3 right-3">
                <input
                  ...
                  className="h-5 w-5 rounded border-zinc-700 bg-zinc-900/80 text-amber-500 focus:ring-amber-500/30 accent-amber-500 cursor-pointer shadow-md"
                />
              </div>
              ...
              {/* Type tag */}
              <div className="absolute bottom-2.5 right-3 text-[11px] font-medium text-zinc-300 bg-black/60 backdrop-blur-md px-2 py-0.5 rounded-md border border-white/10">
                {prop.property_type}
              </div>
            </div>
            ...
            <div className="flex flex-1 flex-col p-4">
              ...
              <div>
                ...
                <div className="mt-1 flex items-center gap-1.5 text-xs text-zinc-400 truncate">
              ...
              {/* Core 4-Grid Metrics */}
              <div className="mt-4 grid grid-cols-2 gap-2 rounded-xl border border-zinc-800/80 bg-[#0A0C10]/60 p-2.5 font-mono">
                <div>
                  <div className="text-[10px] font-semibold text-zinc-500 uppercase font-sans">
                    Area
                  </div>
              ...
              <div className="mt-3 flex items-center justify-between text-[11px] text-zinc-400 border-t border-zinc-800/60 pt-2">
                ...
                {prop.plot_number && (
                  <div className="font-mono text-zinc-300">{prop.plot_number}</div>
                )}
              </div>
              ...
              <div className="mt-4 flex items-center gap-2 pt-2 border-t border-zinc-800/60">
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-zinc-700 bg-zinc-800/60 py-2 text-xs font-semibold text-zinc-200 hover:bg-zinc-700 hover:text-white transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1 rounded-xl border border-cyan-500/30 bg-cyan-500/10 px-2.5 py-2 text-xs font-bold text-cyan-400 hover:bg-cyan-500/20 transition-colors"

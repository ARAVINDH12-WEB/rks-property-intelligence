  ...
  try {
    ...
    const insertResult = await query(
      `INSERT INTO properties (
        ...
        ownership, broker, assigned_to, description, description_ta, seo_title, seo_description, internal_notes,
  ...
  try {
    ...
    const updateRes = await query(
      `UPDATE properties SET
        ...
        latitude = $33,
        longitude = $34,
        amenities = COALESCE($35, amenities),
      ...
      [
        ...
        validated.description_ta !== undefined ? validated.description_ta : current.description_ta,
        validated.seo_title !== undefined ? validated.seo_title : current.seo_title,
        validated.seo_description !== undefined ? validated.seo_description : current.seo_description,
